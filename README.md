# Typhoon bot Terms of Service
- By inviting Typhoon to your Discord server, you agree to these terms.
1. This bot is provided without warranties of any kind. We are not responsible for any downtime, errors, or issues that may arise from using the bot.
2. You agree not to use the bot for malicious purposes, spamming, or violating Discord’s [Terms of Service](https://discord.com/terms) or [Community Guidelines](https://discord.com/guidelines).
3. We reserve the right to stop, suspend, or terminate the bot’s service at any time without notice.
4. We are not liable for any damages resulting from the use of this bot.
5. Typhoon is not affiliated with, endorsed by, or created by Discord Inc.
